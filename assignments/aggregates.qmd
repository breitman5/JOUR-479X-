...
The data frame is a spreadsheet of all of the NBA players from last season and lists their stats.
...
This shows every position listed in the spreadsheet and groups them together by position and then counts them. 
...
A complicating factor is that there are some players who played more than one position. 
...
I think the most interesting story to me here is that small forwards do not play the most minutes in the NBA. I personally feel like the majority of the best players in the NBA are small forwards so it is a tad surprising that the small forwards do not get the most minutes. 