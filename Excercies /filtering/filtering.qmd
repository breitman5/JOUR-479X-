...
```{r}
games <- read_csv("https://dwillis.github.io/sports-data-files/footballlogs22.csv")
```
...
Moses Bol from University of Milwaukee with a true shooting percentage of 83.03%

My criteria was, who had the best 3 point percentage in the country last year with a minimum of 100 attempts. The answer I got was Luke Avdalovic of Pacfic, who had a percentage of over 50% on his threes from last season. I chose this criteria so that if I had to choose any player in college basketball, I would pick Avdalovic.
